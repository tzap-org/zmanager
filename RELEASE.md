...
4. Confirm the release workflow generated:
   ...
   scripts/generate-package-metadata.sh \
     v1.0.7 \
     https://github.com/tzap-org/zmanager/releases/download/v1.0.7 \
     dist/SHA256SUMS \
...
7. Validate the generated WinGet manifests:
   ...
   ```powershell
   winget validate .\dist\package-metadata\winget\TzapOrg.ZManagerCLI\1.0.7
   ```
...
Use [docs/release-notes/1.0.7.md](docs/release-notes/1.0.7.md) as the release
notes source for the `v1.0.7` GitHub release. Update the versioned file first
