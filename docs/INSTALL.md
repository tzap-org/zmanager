...
curl -fsSL https://raw.githubusercontent.com/tzap-org/zmanager/main/install.sh \
  | ZMANAGER_VERSION=v2.1.4 ZMANAGER_INSTALL_DIR="$HOME/bin" sh
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/tzap-org/zmanager/main/install.sh \
  | sudo env ZMANAGER_VERSION=v2.1.4 ZMANAGER_INSTALL_DIR=/usr/local/bin sh
```
...
```sh
curl -LO https://github.com/tzap-org/zmanager/releases/download/v2.1.4/SHA256SUMS
curl -LO https://github.com/tzap-org/zmanager/releases/download/v2.1.4/zm-aarch64-apple-darwin.tar.gz
...
```sh
curl -LO https://github.com/tzap-org/zmanager/releases/download/v2.1.4/SHA256SUMS
curl -LO https://github.com/tzap-org/zmanager/releases/download/v2.1.4/zm-x86_64-unknown-linux-musl.tar.gz
sha256sum -c SHA256SUMS --ignore-missing
